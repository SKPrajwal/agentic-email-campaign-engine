...
# from agents.discriber import ProductDescAgent
...
#     try:
#         result = discriber.run(product_payload)
...
def index_products_multi_process(products_file_name=default_products_file_name):
...
def load_index_multi_process(products_file_name=default_products_file_name):
    global faiss_index, product_metadata
